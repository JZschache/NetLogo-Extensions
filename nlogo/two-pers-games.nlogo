...
to update-slow
  ...
  ask turtles [
    ...
    if (total-n > 0) [
      ...
      let filtered filter [ ( standardised (item 1 ?) total-n) > 2.33 ] zipped
...
to-report standardised [ n total-n ]
  ifelse (is-player-x) [
    report abs (n / total-n - experimenting / n-alt-x) * (sqrt total-n) / (sqrt (experimenting / n-alt-x * (1 - experimenting / n-alt-x)))
  ] [
    report abs (n / total-n - experimenting / n-alt-y) * (sqrt total-n) / (sqrt (experimenting / n-alt-y * (1 - experimenting / n-alt-y)))
  ]
end
@#$#@#$#@
GRAPHICS-WINDOW
...
wait 1</final>
  ...
  <experiment name="exp-no-pure-nash-2" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup-no-decay
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-random-zero-sum" repetitions="100" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
    ...
    <enumeratedValueSet variable="game-name">
      <value value="&quot;RandomZeroSum&quot;"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="exp-two-persons-coordination-3" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-battle-1" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-three-opt-nash" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-battle-2" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-extreme-chicken" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-coordination-4" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-matching-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-no-pure-nash-3" repetitions="10" runMetricsEveryStep="false">
    <setup>set-game
setup-no-decay
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-coordination-1-sofmax" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-coordination-1-sofmax-decay" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:decay-exploration
ql:start</setup>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-coordination-3-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-three-opt-nash-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-battle-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-chicken-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-extreme-chicken-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-prisoner-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-coordination-2-nd-eg-2" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-three-alt-games-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-four-alt-games-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-zero-sum-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-RPS-SG-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-dollar-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-dollar-4-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
...
wait 1</final>
  ...
  <experiment name="exp-two-persons-zero-sum-test-nd-eg" repetitions="1" runMetricsEveryStep="false">
    <setup>set-game
setup
ql:start</setup>
    <go>wait-for-tick</go>
